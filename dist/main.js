    ...
    "jSg4": [function (require, module, exports) {
        ! function (e) {
            ...
            e(".nav-item-search").click(function () {
                var n;
                a || (a = !0, o.addClass("on"), n = function () {
                    e(".local-search-input").focus()
                }, setTimeout(function () {
                    a = !1, n && n()
                }, 200))
            }), e(document).mouseup(function (a) {
                var n = e(".local-search");
                n.is(a.target) || 0 !== n.has(a.target).length || o.removeClass("on")
            ...
            }), (n = e("#totop")).hide(), e(".content").scroll(function () {
                e(".content").scrollTop() > 1e3 ? e(n).stop().fadeTo(200, .6) : e(n).stop().fadeTo(200, 0)
            }), e(n).click(function () {
            ...
            e(".navbar-toggle").on("click", function () {
                e(".content,.sidebar").addClass("anim"), r.toggleClass("on"), s.toggleClass("on")
